<template>
    <div class="tag selCommon">
        ...
        <el-dialog title="详情" :visible.sync="dialogView"  top="10%"  size="" :close-on-click-modal="false">
            ...
            <el-button type="danger" style="margin-left:20px" @click="delcomisson" v-if="formInline.IsFinished=='0'">删除</el-button>
...
<script type="text/ecmascript-6">
    ...
    GetSerCommissionList,  GeneratorSerCommission, GetSerCommissionDetail, SetSerCommission, SetSerCommissionDetail,DeleteServiceConsume} from "@/api/myData"
    export default {
        data () {
            return {
                allLoading:false,
        ...
        methods:{
                ...
                this.$confirm('确定删除选中的提成数据吗?', '提示', {
                    ...
                    DeleteServiceConsume({
                        ...
                        if(res.status){
                            ...
                            this.search()
                            this.view(this.selectserviceData)
                        }else{
            ...
            async GetSerCommissionDetail(params){
                ...
                res.data.forEach(row=>{
                    this.totalAmount += row.commissionAmountTotal
                })
