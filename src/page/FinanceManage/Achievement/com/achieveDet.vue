<template>
    <div class="settled selCommon">
        ...
        <el-table :data="allData" border style="width: 100%;margin-bottom:10px;" height="460" v-if="from">
            <el-table-column prop="fxCode" min-width="120" label="订单编号" ></el-table-column>
