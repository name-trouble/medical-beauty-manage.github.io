    ...
    <div>
         <el-form :inline="true" :model="formInline" class="demo-form-inline form_search" label-width="80px">
           ...
           <el-form-item label="医院:" class="form_item_mt10">
            ...
            <el-form-item label=" " class="form_item_mt10">
                ...
                <el-button type="primary" @click="add" class="searchBtn">添加产品单</el-button>
            </el-form-item>
        </el-form>
        <el-table :data="tableData" border style="width: 100%;margin-top:20px" class="min_table4 smt"  v-loading="loading" @selection-change="handleSelectionChange">
            ...
            <el-table-column  prop="address"  label="付款状态" min-width="100" align="center">
             ...
             <el-table-column prop="nurseName" label="打印" min-width="100" align="center">
                <template slot-scope="scope">
       ...
       <el-button type="primary" @click="AddPrintContent" :disabled="multipleSelection.length == 0" style="margin-top:20px;">批量打印</el-button>
        ...
        <el-dialog title="添加产品单" :visible.sync="dialogFormVisible" :close-on-click-modal="false" size="" top="10%">
            <ordonnance @addClose="addClose" ref="addOrd" v-if="dialogFormVisible" style="width:950px" goodsType="4" @openSelDrug='openSelDrug'></ordonnance>
        </el-dialog>
        <!-- 添加产品单 -->
        ...
        <el-dialog title="编辑" :visible.sync="editDialog" size="" top="10%">
            <edit @addClose="addClose" ref="editOrd" goodsType="4" :mesCode="mesCode" :id="mesId" :payMesShow="payMesShow" v-if="editDialog" style="width:950px" @openSelDrug='openSelDrug'></edit>
        </el-dialog>
        ...
        <el-dialog title="选择产品" :visible.sync="dialogSelDrug"  top="20%"  size="" :close-on-click-modal="false">
...
import {getLodop,needCLodop} from '@/config/LodopFuncs'
    ...
    import selDrug from './com/selProduct'//产品单
