<template>
   <div class="ord">
            <el-form :model="Form"  ref="Form" :inline="true" label-width="100px" class="demo-ruleForm" style="width:680px">
                <el-form-item label="药品：" prop="drugId"  :rules="[{ required: true, message: '不能为空'}]" class="form_item_mt0">
                ...
                <el-form-item label="用法：" class="form_item_mt0">
                    <el-select v-model="Form.usage" style="width:200px" @change="usageChange">
                        <el-option v-for="(item,index) in useMethodList" :key="index" :label="item.DataName" :value="item.DataName"></el-option>
                        ...
                        <el-option label="皮下注射" value="皮下注射"></el-option>
                        <el-option label="皮内注射" value="皮内注射"></el-option> -->
                    </el-select>
                </el-form-item>
                ...
                <el-form-item label="每次用量："  class="form_item_mt0" v-if="Form.usage=='口服'" prop="counts"  :rules="[{ required: true, message: '不能为空'}]">
...
<script>
    ...
    import {GetStockDrugByKeywords,getBaseDataByCode} from "@/api/myData"
    import Vue from "vue"
    import "../lib/ord.less"
    ...
    methods: {
        async getBaseDataByCode(){
            let res = await getBaseDataByCode('0025')
            this.useMethodList= res
        },
        usageChange(){
            this.Form.frequency = ""
            this.Form.counts = ""
            ...
            this.$refs[formName].validate((valid) => {
                if (valid) {
                        ...
                        let obj = {
                            ...
                            realAmount:Number(this.Form.price)*Number(this.Form.num)*this.Form.days,
                            memo:this.Form.memo,
                            ...
                            totalQuantity:this.Form.days*this.Form.num
                        }
