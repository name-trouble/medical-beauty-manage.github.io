    ...
    export default {
        ...
        computed: {
            ...
            tableData1(){
                ...
                return arr.concat({
                    execDate:"合计",orderDate:'',customerName:'',refrenceBranchName:'',marketConsultantName:'',designerName:'',designerAssistName:'',doctorName:'',nurseName:'',itemTypeName:'',projectName:"",deptName:'',orderAmount:'',execCount:'',
