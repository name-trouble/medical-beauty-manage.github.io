<template>
    <div>
        ...
        <el-table :data="tableData" border style="width: 100%;margin-top:15px;margin-bottom:10px;" max-height="560" class="min_table" v-loading="loading">
            ...
            <el-table-column prop="CommandState" label="操作" fixed="right" width="100">
                <template slot-scope="scope">
                    <!-- 已付清未审核  平台账户任何状态可以编辑-->
                    <el-button @click="command(scope.$index,'edit')" type="primary" size="small" :disabled="scope.row.IsPayOff==false&&typeCode!='01'">编辑</el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog ref="pay" title="编辑" :visible.sync="isPopCmd" top="5%" @close="isPopCmd=false" size=""  :close-on-click-modal="false">
            <pop-cmd v-if="isPopCmd" @close='cmdClose' :fx-code="fxCode" :operate="operate"></pop-cmd>
        </el-dialog>
...
<script type="text/ecmascript-6">
    ...
    import PopCmd from './com/commandEdit'
