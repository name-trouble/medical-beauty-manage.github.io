    ...
    <div class="settled selCommon">
        ...
        <el-table :data="tableData" border style="width: 100%;margin-top:15px;margin-bottom:10px;" max-height="600" class="min_table smt"
         v-loading="loading" @sort-change = 'sortChange' show-summary >
            ...
            <el-table-column prop="payDate  " label="用户名" min-width="200"></el-table-column>
            <el-table-column prop="hospitalName" label="手机号" min-width="100"  ></el-table-column>
            <el-table-column prop="receiveBranchName" label="分享码" min-width="100"  ></el-table-column>
            <el-table-column prop="customerName" label="已绑用户" min-width="100" ></el-table-column>
            <el-table-column prop="num" label="分享开单业绩总数" min-width="100" sortable>
                <template slot-scope="scope">
                    <el-button type="" @click="showDet(scope.row,1,'分享开单业绩总数')">{{scope.row.num}}</el-button>
                </template>
            </el-table-column>
            <el-table-column prop="num" label="分享开单业绩总金额" min-width="100" sortable>
                 <template slot-scope="scope">
                    <el-button @click="showDet(scope.row,2,'分享开单业绩总金额')">{{scope.row.num}}</el-button>
                </template>
            </el-table-column>
        </el-table>
        <!-- 分页 -->
