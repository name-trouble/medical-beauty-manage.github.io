        ...
        <div class="el-card content">
            <div class="item" v-for="(item,$index) in list" :key="$index">
                ...
                <el-upload class="avatar-uploader" :action="uploadUrl" :accept="acceptImage" :show-file-list="false" :on-success="success">
                    ...
                    <img :src="baseImgPath+item.pictureUrl" @click="imgIndex=$index" v-else style="border-radius: 8%/25%;">
                </el-upload>
                <div class="url-box">
                    <!-- <div>
                        <span>导航名称：</span>
                    ...
                    <div v-show="item.linkType=='23'">
                        <span> 查询参数： </span>
                        <!-- <el-input style="width:60%" v-model="item.linkUrl" size="small"></el-input> -->
                        <el-select v-model="item.linkUrl" placeholder="请选择" style="width:60%">
                            <el-option v-for="(item,$index) in tagsList" :key="$index" :label="item.tagName" :value="item.code">
                            </el-option>
                        </el-select>
                    </div>
                    <!-- <div>
...
import { AppWidgetListEdit,GetTagByPage } from '@/api/myData'
export default {
    props: {
        data: Object
    },
