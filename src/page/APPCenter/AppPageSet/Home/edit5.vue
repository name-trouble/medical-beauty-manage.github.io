        ...
        <div class="el-card content" >
            ...
            <div class="flex-box" style="margin-top:15px;">
                ...
                <div class="avatar-photo" style="width:120px;height:120px;" @click="showSelectList($index)">
                        ...
                        <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                       <span  class="nameInput">{{item.describe}}</span>
                </div>
                 <div>
            ...
            <!-- 活动列表选择 -->
        <el-dialog title="案例"  :visible.sync="popShow" top="10%" size="">
...
export default {
    ...
    methods: {
        ...
        CaseSelectInfo(id,firstImg,lastImg,name,tab)
        {
            ...
            this.list[this.caseIndex].describe = name;
            this.list[this.caseIndex].pictureUrl = firstImg+'#'+lastImg;
            this.list[this.caseIndex].tab = tab;
            this.popShow = false;
