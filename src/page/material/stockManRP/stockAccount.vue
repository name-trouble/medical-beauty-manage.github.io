...
<!-- 出入库流水账 -->
    <div class="tag selCommon">
        ...
        show-summary :summary-method="getSummaries" max-height="560" class="smt min_table" v-loading="loading">
            ...
            <el-table-column prop="fromHospitalName" label="类别" min-width="90"></el-table-column>
            ...
            <el-table-column prop="fromHospitalName" label="入库数量" min-width="90"></el-table-column>
            <el-table-column prop="fromHospitalName" label="入库单价" min-width="90"></el-table-column>
            <el-table-column prop="fromHospitalName" label="入库金额" min-width="90"></el-table-column>
            <el-table-column prop="fromHospitalName" label="出库数量" min-width="90"></el-table-column>
            <el-table-column prop="fromHospitalName" label="出库单价" min-width="90"></el-table-column>
            <el-table-column prop="fromHospitalName" label="出库金额" min-width="90"></el-table-column>
            ...
            <el-table-column prop="quantityIn" label="有效期" min-width="90"></el-table-column>
            <el-table-column prop="quantityOut" label="生产厂家" min-width="90"></el-table-column>
            <el-table-column prop="remainingCount" label="产地" min-width="90"></el-table-column>
            <el-table-column prop="remainingCount" label="领用部门" min-width="90"></el-table-column>
            <el-table-column prop="remainingCount" label="领用人" min-width="90"></el-table-column>
            <el-table-column prop="remainingCount" label="客户" min-width="90"></el-table-column>
            <el-table-column prop="remainingCount" label="开单日" min-width="90"></el-table-column>
            <el-table-column prop="remainingCount" label="设计师" min-width="90"></el-table-column>
        </el-table>
        <!-- 信息表 -->
