<template>
    <div class="tag selCommon">
        ...
        <el-dialog title="详情" :visible.sync="dialogDet" size="">
            <dialogCross v-if="dialogDet" :propMonth='formInline.month' :dialogData="dialogData" style="width:1200px;"></dialogCross>
        </el-dialog>
    </div>
</template>
        ...
        methods:{
            ...
            exportTable(){
                this.GetDrugPay({
                    ...
                    orderDate:this.formInline.year+'-'+this.formInline.month,
                    type:1,
            ...
            search(){
                ...
                this.GetDrugPay({
                    "hospitalCode": this.formInline.inHospitalCode,
                    "toHospitalCode": this.formInline.outHospitalCode,
                    drugOutDate:this.formInline.year+'-'+this.formInline.month,
                    type:1,
                })
            },
