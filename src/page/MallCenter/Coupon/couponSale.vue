<template>
    <div>
        ...
        <el-table :data="tableData" ref="multipleTable" style="width: 100%;margin-top:10px;margin-bottom:10px;" border class="min_table smt" v-loading="tabLoading"
            ...
            <el-table-column prop="TickName" label="券名称" min-width="160"></el-table-column>
            ...
            <el-table-column prop="SortCode" label="排序" min-width="50"></el-table-column>
            <el-table-column label="操作" width="200px">
                <template slot-scope="scope">
                    <div v-if="scope.row.TickState=='0' || scope.row.TickState==null" class="inline">
                    ...
                    <div v-if="scope.row.TickState=='1'"  class="inline">
                        <el-button type="primary" size="mini" icon="edit"
                        ...
                        <el-button size="mini" type="primary" @click="ticketSort(scope.row)">排序</el-button>
                    </div>

                    <div v-if="scope.row.TickState=='2'"  class="inline">
                        <el-button type="primary" size="mini" icon="edit"
        ...
        <el-dialog title="消费券排序" :visible.sync="ispopEdit" size="">
            <el-form  v-model="filterModel" class="demo-form-inline" label-width="80px">
                <el-form-item label="排序：" class="form_item_mt0">
                    <el-input v-model.number="filterModel.sortCode" style="width: 220px"  placeholder=""></el-input>
                </el-form-item>
                <el-form-item label="" class="form_item_mt10">
...
<script type="text/ecmascript-6">
    ...
    import { getTicketsInfoByPage, getSupplierBySupType, GetGoodsByKeywords, delTicket, activeTicket,UpdateTicketsInfoOnSale,ModifyScortCode } from '@/api/myData'
    ...
    export default {
        ...
        methods: {
            ticketSort(data){
                this.ispopEdit = true
                this.sortId = data.Id
                this.filterModel.sortCode = data.SortCode?data.SortCode:''
            },
            async sure(){
                let res = await ModifyScortCode({
                    id:this.sortId,
                    SortCode:this.filterModel.sortCode
                })
                if(res.status){
