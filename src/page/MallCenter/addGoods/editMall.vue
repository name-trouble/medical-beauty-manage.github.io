<template>
    <div class="mall">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="医院：" prop="hospitalObj" required style="margin-bottom: 10px" v-if="type == 'four'">
                <el-select v-model="ruleForm.hospitalObj" placeholder="请选择" @change="selectHs" style="width: 400px">
            ...
            <el-form-item label="商品详情：" prop="content1" class="form_item_mt10">
                <VueEditor v-model="content1" useCustomImageHandler @image-added="handleImageAdded"></VueEditor>
            </el-form-item>
...
//                主图附图集合
        ...
        methods: {
            ...
            async selectHs() {
                ...
                this.ruleForm.hospital = this.ruleForm.hospitalObj.name
                this.ruleForm.hospitalCode = this.ruleForm.hospitalObj.value
                ...
                try {
                    ...
                    for(let item of res.data){
                        ...
                        if(this.mall.GoodsEntity.SupplierCode == item.code){
                            this.ruleForm.hospitalObj = item
                            this.selectHs()
                        }
                    }
