        ...
        <div style="margin-left:20px">
            ...
            <div class="classification">
                ...
                <div class="classify-footer">
                    <el-button class='edit-btn' type="primary" size='small' icon="el-icon-plus" @click='add(1)'></el-button>
                    <el-button class='edit-btn' type="primary" size='small' icon="el-icon-edit" @click='edit(1)'></el-button>
                    <el-popconfirm
                        class="danger-action"
                        ...
                        icon-color="red"
                        title="确认删除 ？" @confirm="del(1)">
                        <el-button class='edit-btn' type="primary" size='small' icon="el-icon-delete" slot="reference"></el-button>
                    </el-popconfirm>
                </div>
            </div>
            <div class="classification">
                ...
                <div class="classify-footer">
                    <el-button class='edit-btn' type="primary" size='small' icon="el-icon-plus" @click='add(2)'></el-button>
                    <el-button class='edit-btn' type="primary" size='small' icon="el-icon-edit" @click='edit(2)'></el-button>
                    <el-popconfirm
                        class="danger-action"
                        confirm-button-text='确认'
                        cancel-button-text='取消'
                        icon="el-icon-warning"
                        icon-color="red"
                        title="确认删除 ？" @confirm="del(2)">
                        <el-button class='edit-btn' type="primary" size='small' icon="el-icon-delete" slot="reference"></el-button>
                    </el-popconfirm>
                    <!--<el-button class='edit-btn' type="primary" size='small' icon="el-icon-delete" @click='del(2)'></el-button>-->
                </div>
            </div>
            <div class="classification">
                ...
                <div class="classify-footer">
                    <el-button class='edit-btn' type="primary" size='small' icon="el-icon-plus" @click='add(3)'></el-button>
                    <el-button class='edit-btn' type="primary" size='small' icon="el-icon-edit" @click='edit(3)'></el-button>
                    <el-popconfirm
                        class="danger-action"
                        confirm-button-text='确认'
                        cancel-button-text='取消'
                        icon="el-icon-warning"
                        icon-color="red"
                        title="确认删除 ？" @confirm="del(3)">
                        <el-button class='edit-btn' type="primary" size='small' icon="el-icon-delete" slot="reference"></el-button>
                    </el-popconfirm>
                    <!--<el-button class='edit-btn' type="primary" size='small' icon="el-icon-delete" @click='del(3)'></el-button>-->
                </div>
            </div>
        </div>
