    ...
    <div class="selCommon register">
        <el-form :model="ruleForm" :rules="rules" :inline="true" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="服务商推荐人：" class="form_item_mt10" >
                <el-autocomplete v-model="ruleForm.recCode" :fetch-suggestions="queryCus" placeholder="请输入内容" :trigger-on-focus="false" @select="selectCus" style="width:300px;">
            ...
            <el-form-item label="消费商推荐人：" class="form_item_mt10" >
                <el-autocomplete v-model="ruleForm.BranchrecCode" :fetch-suggestions="queryCus1" placeholder="请输入内容" :trigger-on-focus="false" @select="selectCus1" style="width:300px;">
                    <template v-slot="{item}">
                        <my-item-memberItem :item="item"></my-item-memberItem>
                    </template>
                </el-autocomplete>
