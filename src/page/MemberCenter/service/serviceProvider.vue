    ...
    <div class="selCommon MemberManage">
        <el-form :inline="true" :model="formInline" class="demo-form-inline form_search" label-width="85px">
            ...
            <el-form-item label=" " class="form_item_mt10">
                ...
                <el-button type="primary" @click="register('','服务商注册')" class="searchBtn">服务商注册</el-button>
            </el-form-item>
        </el-form>
        <!-- 信息表 -->
        <el-table :data="tableData" border style="width: 100%;margin-top:15px;margin-bottom:10px" class="smt min_table"  v-loading="loading">
            ...
            <el-table-column prop="IsAuth" label="操作" min-width="200" align="center">
                <template slot-scope="scope">
                    ...
                    <!-- <el-button @click="serviceObj(scope.row)" type="primary" size="small">服务店家</el-button> -->
                </template>
            </el-table-column>
        </el-table>
        <!-- 信息表 -->
      ...
      <!--注册弹窗-->
        ...
        <el-dialog title="选择服务店家" :visible.sync="selectDialog" size="" :close-on-click-modal="false" top="10%">
            <shopSelect style="width: 00px" v-if="selectDialog" :mes="mes" @selectShopCallback='selectShopCallback' :selectShopData="selectShopData"></shopSelect>
        </el-dialog>
    </div>
</template>
