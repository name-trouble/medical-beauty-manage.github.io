<template>
    <div class="add">
        <el-form :model="form" :rules="rules" style="width: 400px" ref="form">
            ...
            <el-form-item label="生效时间：" class="form_item_mt10" label-width="90px">
                <el-date-picker v-model="date" type="datetimerange" placeholder="选择日期范围" @change="dateForm"
                                class="form_item_ipt_260"></el-date-picker>
            </el-form-item>
            <el-form-item label="发行数量：" class="form_item_mt10" label-width="90px">
                <el-input-number v-model="form.totalCount" :min="0" :controls="false" class="form_item_ipt_60"></el-input-number>
            ...
            <el-form-item label="红包金额：" class="form_item_mt10" label-width="90px">
                <div style="float:none;height:40px;">
                    ...
                    <el-input-number v-model="form.amount" :min="0" :controls="false" class="form_item_ipt_60" style="float: left"></el-input-number>
                </div>
                <div style="float:none;height:40px;">
            ...
            <el-form-item label="每人限：" class="form_item_mt10" label-width="90px">
            ...
            <el-form-item label="使用门槛：" class="form_item_mt10" label-width="90px">
            ...
            <!-- <el-form-item label="适用栏目：" class="form_item_mt10" label-width="90px">
            ...
            <el-form-item label="适用商品：" class="form_item_mt10" label-width="90px">
                ...
                <span v-if="form.IsAllGoods == 'false'">
                     <el-button @click="add" type="primary" size="small">+添加项目</el-button>
                    <span class="form_item_mes">已选择{{selectProject.length}}个</span> <br/>
                </span>
...
<script type="text/ecmascript-6">
    ...
    import { getProjectCount, getProjectAll , AddRedpacket,GetBranchGradeAll} from '@/api/myData'
    export default {
        // name: "add",
        props: {
            selectProject: {
        ...
        methods: {
            ...
            async AddRedpacket(params){
                try{
                    ...
                    let res = await AddRedpacket(params)
                    if (res.status == true) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        let obj = {
                            ...
                            targetGoodsCodes:this.getArray(this.selectProject),
                            limitAmounts: this.form.limitAmount,//使用门槛
                            limitUsers: this.form.limitCount,//每人限制个数
                            targetUserRuleId:this.currentId?this.currentId:'',
